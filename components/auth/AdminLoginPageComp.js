...
export default function AdminLoginPageComp() {
  ...
  return (
    <div className="flex flex-col items-center justify-center px-4 md:py-10 py-4 bg-[var(--background)] text-[var(--foreground)]">
      {/* Back to Home */}
      {/* <Link
        href="/"
      ...
      {/* Card */}
      <div className="w-full max-w-md rounded-2xl border border-[var(--border)] backdrop-blur-xl shadow-xl p-8">
        {/* Header */}
        <div className="md:mb-8 mb-4">
          <h1 className="text-3xl font-bold text-[var(--foreground)] text-center w-full">
            Admin Login
          </h1>
          <div className="flex items-center justify-center">
            <button className="flex items-center justify-center gap-2 px-3 py-1 rounded-lg text-xs font-medium bg-[var(--accent)]/10 text-[var(--accent)] hover:bg-[var(--accent)]/20 border border-[var(--accent)]/30 transition">
